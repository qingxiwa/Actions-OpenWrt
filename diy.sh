...
#=================================================
# Modify default IP
sed -i 's/192.168.54.1/192.168.0.1/g' package/base-files/files/bin/config_generate
...
# KPR plus+
git clone https://github.com/RealKiro/luci-app-koolproxyR.git package/mine/luci-app-koolproxyR
